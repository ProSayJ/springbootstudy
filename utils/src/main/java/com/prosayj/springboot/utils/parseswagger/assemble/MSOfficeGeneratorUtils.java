...
/**
 * @author yangjian
 * @description 利用JACOB对Microsoft Office Word 进行相关操作
 * @email yangjian@bubi.cn
 * @creatTime 2019/4/8 10:12
 * @since 1.0.0
 */
...
public class MSOfficeGeneratorUtils {
     ...
     * 构造方法
     *
     * @param visible 设置在生成word文档时，程序是否可见
     */
     ...
     * 全局替换
     *
     * @param oldText    要替换的内容
     * @param replaceObj 被替换的内容
     */
     ...
     * 拆分当前单元格
     *
     * @param numRows    拆分的行数，如果不想拆分行，请指定为1
     * @param numColumns 拆分的列数，如果不想拆分列，请指定为1
     */
     ...
     * 向当前插入点插入文本内容
     *
     * @param list 要插入的内容，list.size()代表行数
     */
     ...
     * @param cellRowIdx 行索引
     * @param cellColIdx 列索引
     * @param txt        文本
     */
     ...
     * 设置当前表格边框的粗细
     *
     * @param width 范围：1 < w < 13， 如果是0，就代表?]有框<br/>
     */
