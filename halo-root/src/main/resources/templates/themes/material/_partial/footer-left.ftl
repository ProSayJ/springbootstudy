<div class="mdl-mini-footer--left-section sns-list">
    ...
    <#if options.theme_material_sns_bilibili??>
    <a href="${options.theme_material_sns_bilibili!}" target="_blank">
    ...
    <#if options.theme_material_sns_telegram??>
    <a href="${options.theme_material_sns_telegram!}" target="_blank">
    ...
    <#if options.theme_material_sns_v2ex??>
    <a href="${options.theme_material_sns_v2ex!}" target="_blank">
