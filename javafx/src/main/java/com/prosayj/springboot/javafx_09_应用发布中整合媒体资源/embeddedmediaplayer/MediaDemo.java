package com.prosayj.springboot.javafx_09_应用发布中整合媒体资源.embeddedmediaplayer;
 ...
 * @creatTime 2019/2/21 11:44
 * @since 1.0.0
 */
public class MediaDemo extends Application {
    private Double endTime = new Double(0);
    private Double currentTime = new Double(0);
    private URL resource = this.getClass().getResource("oow2010-2.flv");
    private File file = new File(resource.toString());
