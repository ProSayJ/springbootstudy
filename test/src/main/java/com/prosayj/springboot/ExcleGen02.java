...
//        tableCellHasBorder.setAlignment(HorizontalAlignment.CENTER);
//        tableCellHasBorder.setBorderTop(BorderStyle.THICK);
//        tableCellHasBorder.setTopBorderColor(IndexedColors.BLACK.getIndex());
//        tableCellHasBorder.setBorderBottom(BorderStyle.THICK);
//        tableCellHasBorder.setBottomBorderColor(IndexedColors.BLACK.getIndex());
//        tableCellHasBorder.setBorderLeft(BorderStyle.THICK);
//        tableCellHasBorder.setLeftBorderColor(IndexedColors.BLACK.getIndex());
//        tableCellHasBorder.setBorderRight(BorderStyle.THICK);
...
//        tableCellHasBorder.setFillPattern(FillPatternType.SOLID_FOREGROUND);
//
//
...
//        //水平居中左、右或者中
//        tableCellNoBorderAndOverstriking.setAlignment(horizontalAlignment);
//        //垂直居中对齐
//        tableCellNoBorderAndOverstriking.setVerticalAlignment(VerticalAlignment.CENTER);
