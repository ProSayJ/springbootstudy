package com.prosayj.springboot.javase.base.day31_demo.code.gjp.view;
/*
 *  试图层,用户看到和操作的界面
 *  数据传递给controller层实现
 *  成员位置,创建controller对象
...
import com.prosayj.springboot.javase.base.day31_demo.code.gjp.controller.ZhangWuController;
import com.prosayj.springboot.javase.base.day31_demo.code.gjp.domain.ZhangWu;
...
public class MainView {
	...
	public void editZhangWu() {
		...
		System.out.println("输入日期：格式XXXX-XX-SimpleWaitAndNotify04");
