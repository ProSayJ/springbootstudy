package com.prosayj.springboot.models.seckill.service.impl;
...
/**
 */
//@Compent @Service @Dao @Controller @repos
@Service
public class SeckillServiceImpl implements SeckillService {
   ...
   /* @Autowired
    ...
    //md5字符串,用于混淆md5
    private final String slat = "3425esfwerfer";
    ...
    public ExposerDTO exportSeckillUrl(long seckillId) {
       ...
       /* Seckill seckill = redisDao.getSeckill(seckillId);
        if (seckill == null) {
            ...
            if (seckill == null) {
                return new Exposer(false, seckillId);//秒杀单不存在
            } else {
            //3:放入redis
