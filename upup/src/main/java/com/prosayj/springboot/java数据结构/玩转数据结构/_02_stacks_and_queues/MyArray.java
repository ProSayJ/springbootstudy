...
public class MyArray<E> {
     ...
     * 扩容数组大小容量
     */
    public static final int DEFAULY_CAPATICY_GROUP_UP = 10;
...
//        data = new T[capacity];
    ...
    public void add(int index, E e) {
        ...
        resize(DEFAULY_CAPATICY_GROUP_UP);
        if (size == data.length) {
...
//    resize
    ...
    private void resize(int newCapacity) {
        ...
        if (size == data.length) {
            System.out.println(String.format("数组开始扩容：原数组大小是：【%d】,扩容大小至：【%d】", data.length, newCapacity));
