...
public class CollectionsDemo {
	...
	public static void m1(){
		...
		List<Button> lb = new ArrayList<Button>(){{add(new Button("zhangsulei"));add(new Button("chenli"));}};
		...
		List<Button> lb2 = new ArrayList<Button>(){{add(new Button(1, "zhangsulei"));add(new Button(2, "chenli"));}};
		...
		List<Button> lb3 = new ArrayList<Button>(){{add(new Button(1, "zhangsulei"));add(new Button(2, "chenli"));add(new Button(1, "zhangsulei2"));}};
