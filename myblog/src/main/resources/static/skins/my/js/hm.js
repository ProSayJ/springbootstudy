(function () {
    var h = {}, mt = {}, c = {
        id: "602cadbe543ad0873e1b2dcac1b05837",
        dm: ["tianxiaobo.com"],
    ...
    (function () {
        ...
        (function () {
            (mt.f.Jb = function () {
                ...
                (function () {
                    if (!d) if (d = s, "complete" === document.readyState) a.$ = s; else if (document.addEventListener) document.addEventListener("DOMContentLoaded", g, w), window.addEventListener("load", a, w); else if (document.attachEvent) {
        ...
        return function (d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    e = ["{"];
                    l = mt.o.stringify;
                    for (g in d) if (Object.prototype.hasOwnProperty.call(d, g)) switch (p =
                        d[g], typeof p) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    mt.localStorage.remove = function (b) {
        if (window.localStorage) window.localStorage.removeItem(b); else if (mt.localStorage.ea()) try {
            ...
            g = ["session", "user"], m = "Hm_up_" + c.id, l = {
                init: function () {
                    ...
                    if (b.d(q, "Object") && b.d(e, "Object")) {
                        for (var m in e) if (e.hasOwnProperty(m)) {
                            ...
                            if (g || !((/^_/.test(k) || /_$/.test(k)) && "_iden" !== k)) {
                                var n = e[m];
                                if (n == v) delete q[k]; else {
                                    if (b.d(n, "Object") || b.d(n, "Array")) n = a.stringify(n);
                                    n = b.g(String(n));
                                    l.Fb(f, k, n) && (q[k] = {value: n, scope: l.Ja(f)})
                                }
                            }
                        }
                        "user" === f && l.va()
                    ...
                    a !== r && ("userId" === a && b.d(d.user, "Object") ? (delete d.user.uid_,
                        l.va()) : "user" === a && b.d(d.user, "Object") ? (a = d.user.uid_, d.user = a === r ? {} : {uid_: a}, l.va()) : d[a] !== r && (d[a] = {}))
                }, va: function () {
                    try {
                    ...
                    var e = s, g = d[a];
                    if (256 < encodeURIComponent(String(b)).length || 256 < encodeURIComponent(String(f)).length) e = w; else {
                        var k = g[b];
            ...
            U: function (b, f) {
                return function (g) {
                    ...
                    if (m) {
                        ...
                        if (l && l === g) m.removeAttribute(b.da); else if (f && 0 < f.length && (m = a.rb(m)) && m.length) if (l = m.length, g = m[m.length - 1], 1E4 > l * g.split(">").length) for (g = 0; g < l; g++) e.Ra(b, m[g]); else e.Ra(b, g)
                    }
                }
            }, Ra: function (a, f) {
    ...
    (function () {
        var b = mt.f, a = mt.o, e = mt.event, d = mt.lang, f = h.ma, g = h.V, m = g.T, l = {
            da: "HM_ce", Va: function () {
                if (c.cetrk && c.cetrk.length) {
                    ...
                    for (var d = 0, g = c.cetrk.length; d < g; d++) {
                        ...
                        var u = m.p || "";
                        -1 === u.indexOf(">") && (0 === u.indexOf("#") && (u = u.substring(1)), (u = b.Ga(u)) && e.e(u, "click", f.Kb(l, m)))
                    }
                }
            }, Ea: function (b) {
                ...
                if (a && a.a && d.d(a.a, "Object")) for (var l in a.a) if (a.a.hasOwnProperty(l)) {
                    var u = b.mb(a.a[l] || ""), u = u ? b.Ha(u, w) : "";
                    e[l] = u
                }
                e._iden = f;
    ...
    (function () {
        var b = mt.lang, a = mt.f, e = mt.event, d = mt.h, f = h.A, g = h.I, m = h.V, l = m.T, p = +new Date, x = [],
            t = {
                U: function () {
                    return function (d) {
                        if (h.c && h.c.P && c.aet && c.aet.length) {
                            ...
                            if (e) {
                                var k = h.c.Da, n = a.getAttribute(e, f.Ca) != v ? s : w;
                                if (a.getAttribute(e, f.Ba) == v) if (n) t.fa(t.na(e, d)); else {
                                    var z = a.X(e);
                                    if (b.J(k, "*") || b.J(k, z)) t.fa(t.na(e, d)); else for (; e.parentNode != v;) {
                                        var n = e.parentNode, z = a.X(n), y = "a" === z && b.J(k, "a") ? s : w,
    ...
    (function () {
        var b = mt.event, a = mt.h, e = h.A, d = h.I, f = +new Date, g = [], m = v, l = {
            gb: function () {
                return function () {
    ...
    (function () {
        ...
        function a() {
            ...
            if ((!m || !p) && l && x) k = s, q = +new Date; else if (m && p && (!l || !x)) k = w, u += +new Date - q;
            m = l;
            p = x;
            y = setTimeout(a, 100)
        }
        ...
        function e(a) {
            var n = document, b = "";
            if (a in n) b = a; else for (var d = ["webkit", "ms", "moz", "o"], y = 0; y < d.length; y++) {
        ...
        var f = mt.event, g = h.I, m = s, l = s, p = s, x = s, t = +new Date, q = t, u = 0, k = s,
            n = e("visibilityState"), z = e("hidden"), y;
        a();
        (function () {
    ...
    (function () {
        var b = mt.lang, a = h.A, e = h.load, d = {
            Db: function (d) {
    ...
    (function () {
        ...
        var e = mt.url, d = mt.lang, f = mt.o, g = mt.h, m = h.A, l = h.I, p = h.eb, x = h.load, t = h.ka, q = h.V,
            u = q.T, k = {
                R: [], ca: 0, Na: w,
                z: {za: "", page: ""}, init: function () {
                    k.j = 0;
                    q.init();
                    l.e("pv-b", function () {
                        k.fb();
                    ...
                    a.cmd[c.id] = {push: k.wa}
                }, ib: function () {
                    if (0 < k.R.length) for (var a = 0, b = k.R.length; a < b; a++) k.wa(k.R[a]);
                    k.R =
                        v
                }, wa: function (a) {
                    var b = a[0];
                    ...
                    if (!(3 > a.length)) {
                        ...
                        a = d.g(a[2]);
                        if (e !== r && a !== r) {
                            var y = decodeURIComponent(t.getData("Hm_ct_" + c.id) || ""), y = b(y, e, 1, a);
                    ...
                    if (1 <
                        ...
                        a = a[2];
                        if (d.J(m.Oa, e) && d.d(a, "Function") && (b.plugins = b.plugins || {}, b.F = b.F || {}, b.plugins[e] = a, b.w = b.w || [], a = b.w.slice(), e && a.length && a[0][1] === e)) for (var f = 0, g = a.length; f < g; f++) {
                            var k = a[f][2] || {};
                            if (b.plugins[e] && !b.F[e]) b.F[e] = new b.plugins[e](k), b.w.shift(); else break
                        }
                    }
                }, _requirePlugin: function (a) {
                    if (1 < a.length) {
                        var b = window._hmt, e = a[1], f = a[2] || {};
                        if (d.J(m.Oa, e)) if (b.plugins = b.plugins || {}, b.F = b.F || {}, b.plugins[e] && !b.F[e]) b.F[e] = new b.plugins[e](f); else {
                            b.w = b.w ||
                                [];
                            for (var f = 0, g = b.w.length; f < g; f++) if (b.w[f][1] === e) return;
                            b.w.push(a);
    ...
    (function () {
        ...
        var a = mt.url, e = mt.Sa, d = mt.xa, f = mt.lang, g = mt.cookie, m = mt.h, l = mt.sessionStorage, p = mt.o,
            x = mt.event, t = h.ka, q = h.V, u = q.T, k = h.A, n = h.load, z = h.I;
        b.prototype = {
            Q: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var b = document.location.hash.substring(1), d = RegExp(c.id),
                    e = a.N(document.referrer) === k.Ua ? 1 : 0, f = a.m(b, "jn"),
    ...
    (function () {
        var b = mt.event, a = mt.lang, e = h.A;
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.c && (c.med || (!b.Ma || 7 < b.pb()) && c.cvcc)) {
            var f, g, m, l, p = function (a) {
                ...
                g.v = b;
                if (e) {
                    var k = e.getAttribute("href"), l = e.getAttribute("onclick") ? "" + e.getAttribute("onclick") : v,
                        p = e.getAttribute("id") || "";
                    m.test(k) ? (g.sn =
            ...
            if ("undefined" !== typeof l && "undefined" !== typeof m) {
                ...
                var k = function (b, d) {
                    ...
                    if (a.d(d, "Array") || a.d(d, "NodeList")) for (var e = 0, f = d.length; e < f; e++) if (u === d[e]) return t(g + b + "/" + (e + 1), d[e]), w
                };
